...
import 'package:e_ktg_mobile/presentation/fasilitas/detail/fasilitas_resto_detail_page.dart';
import 'package:flutter/material.dart';
import 'package:cached_network_image/cached_network_image.dart';
import 'package:e_ktg_mobile/core/constants/colors.dart';
import 'package:flutter_image_slideshow/flutter_image_slideshow.dart';

class RestoFasilitasCard extends StatelessWidget {
  final Resto data;
  const RestoFasilitasCard({Key? key, required this.data}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    ...
    return GestureDetector(
      onTap: () {
        context.push(
          FasilitasRestoDetailPage(data: data),
        );
      },
      child: Container(
