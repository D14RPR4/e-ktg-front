...
import 'package:e_ktg_mobile/presentation/fasilitas/detail/comment/comment_hotel_page.dart';
import 'package:flutter/material.dart';
import 'package:flutter_bloc/flutter_bloc.dart';
import 'package:flutter_image_slideshow/flutter_image_slideshow.dart';
import '../../../../core/components/custom_scaffold.dart';
import '../bloc/fasilitas_hotel/like_hotel/like_hotel_bloc.dart';

class FasilitasHotelDetailPage extends StatefulWidget {
  final Hotel data;

  const FasilitasHotelDetailPage({super.key, required this.data});

  @override
  State<FasilitasHotelDetailPage> createState() =>
      _FasilitasHotelDetailPageState();
}

class _FasilitasHotelDetailPageState extends State<FasilitasHotelDetailPage> {
      ...
      child: BlocBuilder<HotelBloc, HotelState>(
        builder: (context, state) {
          return state.maybeWhen(
            ...
            success: (hotelList) {
              final updatedData = hotelList.data.firstWhere(
  ...
  Widget _buildContent(BuildContext context, Hotel data) {
  ...
  Widget _buildInfoSection(Hotel data) {
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        Text(
