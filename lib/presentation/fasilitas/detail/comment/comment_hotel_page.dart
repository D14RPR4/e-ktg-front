...
class CommentHotelPage extends StatefulWidget {
  final String? postId;

  const CommentHotelPage({
    Key? key,
    this.postId,
  }) : super(key: key);

  @override
  State<CommentHotelPage> createState() => _CommentHotelPageState();
}

class _CommentHotelPageState extends State<CommentHotelPage> {
  int? userId;
