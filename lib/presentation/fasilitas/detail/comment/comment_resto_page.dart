...
class CommentRestoPage extends StatefulWidget {
  final String? postId;

  const CommentRestoPage({
    Key? key,
    this.postId,
  }) : super(key: key);

  @override
  State<CommentRestoPage> createState() => _CommentRestoPageState();
}

class _CommentRestoPageState extends State<CommentRestoPage> {
  int? userId;
