...
import 'package:e_ktg_mobile/presentation/atraksi/pages/detail/comment/comment_budaya_page.dart';
import 'package:flutter/material.dart';
import 'package:flutter_bloc/flutter_bloc.dart';
import 'package:flutter_image_slideshow/flutter_image_slideshow.dart';
import '../../../../core/components/custom_scaffold.dart';
import '../../../../data/model/responses/wisata_budaya_response.dart';
import '../../bloc/wisata_budaya/get_budaya/budaya_bloc.dart';

class WisataBudayaDetailPage extends StatefulWidget {
  final Budaya data;

  const WisataBudayaDetailPage({super.key, required this.data});

  @override
  State<WisataBudayaDetailPage> createState() => _WisataBudayaDetailPageState();
}

class _WisataBudayaDetailPageState extends State<WisataBudayaDetailPage> {
  void _handlePostLikeDislike(BuildContext context, String postId) {
    context.read<LikeBloc>().add(LikeEvent.like(postId));
  }

  Future<void> _refreshBudaya() async {
    context.read<BudayaBloc>().add(BudayaEvent.getAllBudaya());
  }
      ...
      child: BlocBuilder<BudayaBloc, BudayaState>(
        builder: (context, state) {
          return state.maybeWhen(
            ...
            success: (BudayaList) {
              final updatedData = BudayaList.data.firstWhere(
  ...
  Widget _buildContent(BuildContext context, Budaya data) {
    return CustomScaffold(
      appBarTitle: Text(data.nama),
      body: RefreshIndicator(
        onRefresh: _refreshBudaya,
        child: ListView(
          children: [
            Container(
  ...
  Widget _buildInfoSection(Budaya data) {
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        Text(
