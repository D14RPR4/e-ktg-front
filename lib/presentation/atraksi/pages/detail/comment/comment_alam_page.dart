...
class CommentAlamPage extends StatefulWidget {
  final String? postId;

  const CommentAlamPage({
    Key? key,
    this.postId,
  }) : super(key: key);

  @override
  State<CommentAlamPage> createState() => _CommentAlamPageState();
}

class _CommentAlamPageState extends State<CommentAlamPage> {
  int? userId;
