...
import 'package:e_ktg_mobile/presentation/atraksi/pages/detail/comment/comment_alam_page.dart';
import 'package:flutter/material.dart';
import 'package:flutter_bloc/flutter_bloc.dart';
import 'package:flutter_image_slideshow/flutter_image_slideshow.dart';
import '../../../../core/components/custom_scaffold.dart';

class WisataAlamDetailPage extends StatefulWidget {
  final Alam data;

  const WisataAlamDetailPage({super.key, required this.data});

  @override
  State<WisataAlamDetailPage> createState() => _WisataAlamDetailPageState();
}

class _WisataAlamDetailPageState extends State<WisataAlamDetailPage> {
  void _handlePostLikeDislike(BuildContext context, String postId) {
    context.read<LikeBloc>().add(LikeEvent.like(postId));
  }

  Future<void> _refreshAlam() async {
  ...
  Widget build(BuildContext context) {
    return BlocListener<LikeBloc, LikeState>(
      ...
      child: BlocBuilder<AlamBloc, AlamState>(
        builder: (context, state) {
          return state.maybeWhen(
            orElse: () => _buildContent(context, widget.data),
            success: (alamList) {
              final updatedData = alamList.data.firstWhere(
  ...
  Widget _buildContent(BuildContext context, Alam data) {
  ...
  Widget _buildInfoSection(Alam data) {
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        Text(
