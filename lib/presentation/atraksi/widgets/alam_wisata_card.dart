...
import 'package:e_ktg_mobile/presentation/atraksi/pages/detail/wisata_alam_detail_page.dart';
import 'package:flutter_image_slideshow/flutter_image_slideshow.dart';

class AlamWisataCard extends StatelessWidget {
  final Alam data;
  const AlamWisataCard({Key? key, required this.data}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return GestureDetector(
      onTap: () {
        context.push(
          WisataAlamDetailPage(data: data),
        );
      },
      child: Container(
