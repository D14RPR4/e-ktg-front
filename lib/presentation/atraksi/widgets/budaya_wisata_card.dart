...
import '../pages/detail/wisata_budaya_detail.dart';

class BudayaWisataCard extends StatelessWidget {
  final Budaya data;
  const BudayaWisataCard({Key? key, required this.data}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return GestureDetector(
      onTap: () {
        context.push(
          WisataBudayaDetailPage(data: data),
        );
      },
      child: Container(
