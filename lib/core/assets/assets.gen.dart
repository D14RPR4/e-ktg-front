...
class $AssetsImagesGen {
  ...
  /// File path: assets/images/auth2.png
  AssetGenImage get auth2 => const AssetGenImage('assets/images/auth2.png');
  ...
  /// File path: assets/images/img-failed.png
  AssetGenImage get imgFailed =>
      const AssetGenImage('assets/images/img-failed.png');
...
class $AssetsImagesBannerGen {
  ...
  /// File path: assets/images/banner/banner-1.png
  AssetGenImage get banner1 =>
      const AssetGenImage('assets/images/banner/banner-1.png');

  /// File path: assets/images/banner/banner-2.png
  AssetGenImage get banner2 =>
      const AssetGenImage('assets/images/banner/banner-2.png');

  /// File path: assets/images/banner/banner-3.png
  AssetGenImage get banner3 =>
      const AssetGenImage('assets/images/banner/banner-3.png');

  /// File path: assets/images/banner/banner-4.png
  AssetGenImage get banner4 =>
      const AssetGenImage('assets/images/banner/banner-4.png');
