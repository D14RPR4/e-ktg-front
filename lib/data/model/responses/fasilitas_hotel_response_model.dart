...
class FasilitasHotelResponseModel {
  ...
  FasilitasHotelResponseModel({
    required this.data,
  });

  factory FasilitasHotelResponseModel.fromJson(String str) =>
      FasilitasHotelResponseModel.fromMap(json.decode(str));

  String toJson() => json.encode(toMap());

  factory FasilitasHotelResponseModel.fromMap(Map<String, dynamic> json) =>
      FasilitasHotelResponseModel(
        data: List<Hotel>.from(json["data"].map((x) => Hotel.fromMap(x))),
      );
