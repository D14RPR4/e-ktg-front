...
class WisataBudayaResponseModel {
  ...
  WisataBudayaResponseModel({
    required this.data,
  });

  factory WisataBudayaResponseModel.fromJson(String str) =>
      WisataBudayaResponseModel.fromMap(json.decode(str));

  String toJson() => json.encode(toMap());

  factory WisataBudayaResponseModel.fromMap(Map<String, dynamic> json) =>
      WisataBudayaResponseModel(
        data: List<Budaya>.from(json["data"].map((x) => Budaya.fromMap(x))),
      );
