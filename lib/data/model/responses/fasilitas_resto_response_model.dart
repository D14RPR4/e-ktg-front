...
class FasilitasRestoResponseModel {
  ...
  FasilitasRestoResponseModel({
    required this.data,
  });

  factory FasilitasRestoResponseModel.fromJson(String str) =>
      FasilitasRestoResponseModel.fromMap(json.decode(str));

  String toJson() => json.encode(toMap());

  factory FasilitasRestoResponseModel.fromMap(Map<String, dynamic> json) =>
      FasilitasRestoResponseModel(
        data: List<Resto>.from(json["data"].map((x) => Resto.fromMap(x))),
      );
